...
type IRepository interface {
	...
	ProductVariants(opts ...Option) repository_product_variants.ICustomQueries
...
func (r *repository) ProductVariants(opts ...Option) repository_product_variants.ICustomQueries {
	options := parseOptions(opts...)
	if options.Tx != nil {
		return r.productVariants.WithTx(options.Tx)
	}
...
func (r *repository) AttributeValues(opts ...Option) repository_attribute_values.ICustomQueries {
	options := parseOptions(opts...)
	if options.Tx != nil {
		return r.attributeValues.WithTx(options.Tx)
	}
	return r.attributeValues
}

func (r *repository) ProductAttributeValues(opts ...Option) repository_product_attribute_values.Querier {
	options := parseOptions(opts...)
	if options.Tx != nil {
