...
type IProduct interface {
	...
	GetCategoryById(ctx context.Context, id uuid.UUID) (*models.Product, error)
	GetCategoryBySlug(ctx context.Context, slug string) (*models.Product, error)
}
...
func (s Service) CreateProduct(ctx context.Context, dto CreateDTO) (*models.Product, error) {
	params := repository_products.CreateParams{
		...
		StockStatus:     pgtypeutils.EncodeText(tools.Pointer(dto.StockStatus.String())),
...
func (s Service) GetCategoryById(ctx context.Context, id uuid.UUID) (*models.Product, error) {
...
func (s Service) GetCategoryBySlug(ctx context.Context, slug string) (*models.Product, error) {
