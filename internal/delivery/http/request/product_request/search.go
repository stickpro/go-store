...
// SearchProductsRequest holds the fixed (non-dynamic) query params of the storefront
// full-text product search. Attribute filters are passed as dynamic params and parsed
// separately, exactly like the category listing:
